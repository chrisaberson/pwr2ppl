...
#'Requires correlatiosn between all variables as sample size.
...
#'@param n Sample size
#'@param mvar Number of Mediators
...
powerab1<-round(1-pnorm(zpowerab1),4)
...
powerab1<-round(1-pnorm(zpowerab1),4)
powerab2<-round(1-pnorm(zpowerab2),4)
powerall<-round(1-pnorm(zpowerall),4)
print(paste("Power for n =", n,"mediator 1", "=", powerab1))
...
print(paste("Power for n = ",n,"Total Mediation", "=", powerall))}
  ...
  powerab1<-round(1-pnorm(zpowerab1),4)
  powerab2<-round(1-pnorm(zpowerab2),4)
  powerab3<-round(1-pnorm(zpowerab3),4)
  powerall<-round(1-pnorm(zpowerall),4)
  print(paste("Power for n =", n,"mediator 1", "=", powerab1))
  print(paste("Power for n =", n,"mediator 2", "=", powerab2))
  ...
  print(paste("Power for n = ",n,"Total Mediation", "=", powerall))}
    ...
    powerab2<-round(1-pnorm(zpowerab2),4)
    powerab3<-round(1-pnorm(zpowerab3),4)
    powerab4<-round(1-pnorm(zpowerab4),4)
    powerall<-round(1-pnorm(zpowerall),4)
    print(paste("Power for n =", n,"mediator 1", "=", powerab1))
    print(paste("Power for n =", n,"mediator 2", "=", powerab2))
    print(paste("Power for n =", n,"mediator 3", "=", powerab3))
