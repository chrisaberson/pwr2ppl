...
#'@param rxww Correlation between moderator (w) and interaction (xw) - defaults to 0
...
#'@examples modmed8(rxw<-.2, rxm<-.3, rxxw=0, rxy=.3,rwm=.4,
#'rxww=0,rwy<-.35, rxwm<-.4, rxwy=0, rmy=.3, n=100, rep=2000,alpha=.05)
